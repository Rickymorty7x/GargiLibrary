...
function App() {
  ...
  return <div className="page-shell">
    <header><a className="brand" href="./"><span className="brand-mark"><BookOpen size={23}/></span><span>Gargi<span>Library</span></span></a><nav><a href="#about">About</a><a href="https://github.com/Rickymorty7x/GargiLibrary" target="_blank">GitHub</a>{installPrompt && <button className="install-btn" onClick={installApp}>Install app</button>}<button className="icon-btn" onClick={() => setShowSettings(true)} aria-label="Search API settings"><Settings size={20}/></button></nav></header>
    <main>
